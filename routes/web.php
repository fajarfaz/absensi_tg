...
Route::get('/pegawai-non-aktif', [karyawanController::class, 'pegawaiNonAktif'])->middleware('admin');
...
Route::post('/pegawai/soft-delete/{id}', [karyawanController::class, 'softDelete'])->middleware('admin');
...
Route::delete('/data-dinas-luar/delete/{id}', [DinasLuar::class, 'deleteDinasLuar'])->middleware('admin');
...
Route::get('/pengumuman', [AnnouncementController::class, 'index'])->middleware('admin');
...
Route::get('/pengumuman/show/{id}', [AnnouncementController::class, 'show'])->middleware('auth');
Route::get('/pengumuman/tambah', [AnnouncementController::class, 'create'])->middleware('admin');
Route::post('/pengumuman/tambah-proses', [AnnouncementController::class, 'store'])->middleware('admin');
Route::get('/pengumuman/{id}/edit', [AnnouncementController::class, 'edit'])->middleware('admin');
Route::put('/pengumuman/{id}/update', [AnnouncementController::class, 'update'])->middleware('admin');
Route::delete('/pengumuman/{id}/delete', [AnnouncementController::class, 'destroy'])->middleware('admin');
Route::patch('/pengumuman/{id}/publish', [AnnouncementController::class, 'publish'])->middleware('admin');
