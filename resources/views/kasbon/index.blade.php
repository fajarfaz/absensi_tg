                            ...
                            <tbody>
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->User->name  }}</td>
                                        @else
                                        <td>Data User dengan ID {{ $d->user_id }} Telah di hapus.
                                            Apakah anda ingin menghapus data kasbon ini? <p class="text-danger">Data rekap kasbon akan hilang selamanya!</p>
                                            <ul class="action">
