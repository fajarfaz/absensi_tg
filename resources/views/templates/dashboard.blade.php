    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="{{ url('/dashboard') }}"><img class="img-fluid for-light" src="{{ asset('/storage/'.$settings->logo) }}" style="width: 50px" alt=""></a><div style="font-size: 20px; color:white; display:inline">{{ $settings->name }}</div>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
              <div class="toggle-sidebar"><i class="fa fa-cog status_toggle middle sidebar-toggle"> </i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="{{ url('/dashboard') }}"><img class="img-fluid" src="{{ url('/myhr/images/logo.png') }}" style="width: 50px"alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="{{ url('/dashboard') }}"><img class="img-fluid" src="{{ url('/myhr/images/logo.png') }}" style="width: 50px"alt=""></a>
                    ...
                    <ul>
                      ...
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            <i data-feather="bell"></i><span>Pengumuman</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('/pengumuman') }}">Daftar Pengumuman</a></li>
                            <li><a href="{{ url('/pengumuman-published') }}">Pengumuman Terbit</a></li>
                        </ul>
                    </li>

                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            <i data-feather="book"></i><span>Artikel/Berita</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('/blog') }}">Daftar Berita/Artikel</a></li>
                            <li><a href="{{ url('/blog/tambah') }}">Tambah Berita/Artikel</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            <i data-feather="calendar"></i><span>Acara</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('/acara') }}">Daftar Acara</a></li>
                            <li><a href="{{ url('/acara/tambah') }}">Tambah Acara</a></li>
                        </ul>
                    </li>
                      ...
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/jabatan') }}"><i data-feather="package"> </i><span>Jabatan</span></a>
                      </li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 p-0 footer-left">
                <p class="mb-0">Copyright © 2025 Wahab | Cestindo. All rights reserved.</p>
              </div>
