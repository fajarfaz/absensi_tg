                            ...
                            <tbody>
                                @foreach ($kunjungan as $kun)
                                    <tr>
                                        ...
                                        <td>{{ $kun->user->name ?? 'Data User ID '.$kun->user_id.' ini telah di hapus' }}</td>
                                        <td>{{ $kun->tanggal ?? '-' }}</td>
                                        <td>{{ $kun->visit_in ?? '-' }}</td>
                                        <td>{{ $kun->visit_out ?? '-' }}</td>

                                        <td>
                                            @if(isset($kun->user->id))
                                            ...
                                            @else
                                            <a href="{{ url('/maps/'.$kun->lat.'/'.$kun->long.'/'.$kun->user_id) }}" style="background-color: rgb(146, 146, 146)" class="btn btn-xs" target="_blank"><i class="fa fa-eye" class="me-2"></i> Lihat</a>
                                            @endif
                                        </td>
                                        <td>
