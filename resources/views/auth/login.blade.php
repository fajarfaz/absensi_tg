...
<body class="authentication-bg position-relative">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header py-4 text-center bg-success">
                            <!--<a href="{{ url('/login-admin') }}">-->
                                <span><img src="{{ url('/gacoan/assets/images/logo1.png') }}" alt="logo" height="125"></span>
                            </a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center pb-0 fw-bold">Selamat Datang</h4>
                                <p class="text-muted mb-4">Untuk Tetap Terhubung dengan System kami, silakan login dengan Akun Anda</p>
                            </div>
                            ...
                            <form method="post" action="{{ url('/login-proses') }}">
                                ...
                                <p class="mb-9 fw-3 text-center ">Anda Belum Memiliki Akun? <a href="{{ url('/register') }}" class="auth-link-rg">Daftar Karyawan</a></p>
                                <div class="mb-3 mb-0 text-center">
                                    <p class="text-muted mb-0">--- Absen Face Recognition ---</p>
                                    <a href="{{ url('/presensi') }}" class="btn btn-success">Absen Masuk</a>
                                    <a href="{{ url('/presensi-pulang') }}" class="btn btn-success">Absen Pulang</a>
                                </div>
                            </form>
                        </div> <!-- end card-body -->
                    </div>
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="bg-body">
            ...
            <a href="https://hadirkan.com/" target="_blank">© Central IT Solusindo - CESTINDO</a>
        </span>
    </footer>
