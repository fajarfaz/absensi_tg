...
<body>
  ...
  <div class="container">
    @if($logo_data)
        <img src="data:{{ $logo_mime }};base64,{{ $logo_data }}" style="width: 95px; float:left">
    @endif
    <h3 style="text-transform: uppercase;">{{ $settings->name }}</h3>
    <span style="font-size: 11px">{{ $settings->alamat }}</span>
    <br>
    <span style="font-size: 11px">{{ $settings->email }} - ({{ $settings->phone }})</span>
    <hr>
    <center>
    ...
    <table style="font-size: 13px">
      <tbody>
        ...
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Reimbursement</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_reimbursement) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
    ...
    <table style="font-size: 13px">
      <tbody>
        ...
        <tr>
          ...
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="font-size: 50px; color: blue; padding-left: 10px; padding-right: 10px; font-weight: bold; border: 1px solid #000;">Rp {{ number_format($data->grand_total) }}</td>
        </tr>
        <br>
        <tr>
